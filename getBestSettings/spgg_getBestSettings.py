...
def execute_spgg_getBestSettings(temp):
    aircon_status_result = pd.read_csv("saved_data/aircon_status_SPGG_getBestSettings.csv")
        ...
        formatted_results = [
            {
                "others": {
                    ...
                    "total_time_maintained": int(best_entries["total_time_maintained"]), 
